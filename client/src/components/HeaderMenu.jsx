  ...
  return (
    <div className="relative">
      ...
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="text-utility lg:text-utility-lg text-ink sm:hidden"
      ...
      {open && (
        <div className="absolute right-0 top-full z-10 mt-2 flex flex-col gap-3 border border-hairline bg-paper p-4 text-utility lg:text-utility-lg sm:hidden">
          {children}
        </div>
      )}
    </div>
