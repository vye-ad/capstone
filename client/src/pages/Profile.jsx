...
export default function Profile() {
  ...
  return (
    <main className="min-h-screen px-4 py-6">
      ...
      <div className="mt-4 flex flex-col gap-8 lg:flex-row lg:gap-16">
          ...
          <form onSubmit={handleChangePassword} className="flex w-64 flex-col gap-4">
            <label className="flex flex-col gap-1">
              ...
              {passwordFieldErrors.currentPassword && (
                <p className="text-utility lg:text-utility-lg text-danger">{passwordFieldErrors.currentPassword}</p>
              )}
            </label>
            <label className="flex flex-col gap-1">
              ...
              {passwordFieldErrors.newPassword && (
                <p className="text-utility lg:text-utility-lg text-danger">{passwordFieldErrors.newPassword}</p>
              )}
            </label>
